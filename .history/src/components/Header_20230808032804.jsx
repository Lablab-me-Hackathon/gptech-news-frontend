...
function Header() {
  ...
  return (
    <div className="flex-box px-4 sm:flex-row lg:flex-row  justify-between w-full py-5 bg-gray-950 text-center">
      <Logo />
      ...
      <div className="absolute top-20 left-0 bg-gray-950 flex-box flex-col pb-8 w-full z-40">
        {menuOpen ? (
          <>
            {" "}
            <MenuItems /> <Sign />
