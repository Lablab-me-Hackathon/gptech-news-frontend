...
function Sign() {
  ...
  return (
    <div onClick={() => navigate("/sign-up")} className="flex-box w-40 h-12 cursor-pointer uppercase text-center">
      <div className="px-1 py-3.5 text-white bg-gray-400 bg-opacity-25 rounded justify-start items-start gap-2.5 inline-flex hover:bg-white hover:text-blue-900">
