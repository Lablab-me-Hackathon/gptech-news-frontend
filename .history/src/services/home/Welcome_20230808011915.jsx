          ...
          >
            <div className="flex h-full items-center justify-center">
              <div className="px-6 text-center text-white md:px-12 ">
                <h1 className="mb-6 text-5xl font-bold drop-shadow-lg  shadow-blue-600/50">GPTechNews</h1>
                <h2 className="text-3xl font-bold md:text-5xl leading-relaxed md:leading-snug mb-2 drop-shadow-lg  shadow-blue-600/50">IT News : Grow your career</h2>
