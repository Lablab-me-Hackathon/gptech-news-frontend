...
function Welcome() {
  ...
  return (
    <div className="bg-black w-full text-white py-2 flex-box">
      <div className="w-full flex-box flex-col md:flex-row my-6 home bg-cover bg-no-repeat">
        <div className="text-center h-screen overflow-hidden w-full py-10 flex-box flex-col scroll-smooth"><div className="flex-box p-8">
