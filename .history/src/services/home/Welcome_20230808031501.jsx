...
function Welcome() {
  ...
  return (
    <div className="w-full md:h-screen text-white py-2 flex-box home">
          ...
          >
            <div className="flex-box">
              <div className="px-6 text-center text-white md:px-12">
                <h1 className="mb-6 text-5xl md:text-6xl lg:text-8xl font-bold drop-shadow-lg  shadow-blue-600/50">GPTechNews</h1>
                <h3 className="text-3xl font-bold md:text-4xl lg:text-6xl leading-relaxed md:leading-snug mb-2 drop-shadow-md  shadow-black">IT News : Grow your career</h3>
