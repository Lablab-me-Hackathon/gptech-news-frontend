          ...
          >
            <div className="flex h-full items-center justify-center">
              <div className="px-6 text-center text-white md:px-12 ">
                ...
                <p className="text-sm md:text-base text-gray-50 drop-shadow-lg  shadow-black">Explore your favorite news and register now to stay up-to-date and discover exciting articles.</p>
                <Explore />
              </div>
            </div>
          </div>
