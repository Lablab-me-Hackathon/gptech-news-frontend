      ...
      <div className="container w-full flex flex-col md:flex-row items-center my-12 md:my-24 flex-box">
        ...
        <div className="p-8 mt-12 mb-6 md:mb-0 md:mt-0 ml-0 md:ml-12 lg:w-2/3  justify-center">
          <div className="h-48 flex flex-wrap content-center">
            <div>
              <img
                className="w-40 h-50 inline-block mt-28 hidden xl:block"
                src="googleNews.jpg"
              />
            </div>
            <div>
              <img
                className="w-40 h-50 inline-block mt-24 md:mt-0 p-8 md:p-0"
                src="goodNews.jpg"
              />
            </div>
            <div>
              <img
                className="w-40 h-50 inline-block mt-28 hidden lg:block"
                src="newsPaper.jpg"
              />
            </div>
          </div>
