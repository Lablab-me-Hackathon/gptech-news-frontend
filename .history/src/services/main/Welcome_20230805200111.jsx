...
function Welcome() {
  return (
    <div className="bg-black w-full text-white py-2 h-full flex-box py-3">
      <div className="container w-full flex flex-col md:flex-row items-center md:my-24 flex-box">
