function Cards() {
  return (
    <div>
      <div className="Our application can track and scrap IT news from different
            sources like Dev.to & Medium And adding a chatbot in the platform so
            that the user can talk to ai assistant for searching on such topics. rounded overflow-hidden shadow-lg">
        <img
          className="w-full"
          src="ainews.jpg"
          alt="ai news article"
