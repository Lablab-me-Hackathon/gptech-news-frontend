        ...
        >
          <div className="flex h-full items-center justify-center">
            <div className="px-6 text-center text-white md:px-12">
              ...
              <h3 className="mb-8 text-3xl font-bold text-3xl md:text-5xl leading-relaxed md:leading-snug mb-2">IT News : Grow your career</h3>
              <p>Explore your favorite news and register now to stay up-to-date and discover exciting articles.</p>
              <button
                type="button"
