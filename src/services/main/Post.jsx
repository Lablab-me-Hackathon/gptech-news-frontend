...
//   const parser = new DOMParser();
  ...
  const getArticles = async () => {
    try {
      const res = await axios.get('https://dev-news.onrender.com')
    ...
    <div className="border p-5 rounded-xl bg-gray-800 w-full">
      <div
        ...
        <div className="bg-black flex-box rounded-t-lg py-3 px-6 w-full">
          <img src="https://dev-to-uploads.s3.amazonaws.com/uploads/logos/resized_logo_UQww2soKuUsjaOGNB38o.png" alt="article" />
