const Contact = () => {
  return (
    <div
      className="bg-secondbackground flex flex-row items-center justify-center w-full gap-20 h-[240px] mt-40"
    ...
    >
      ...
      <div className="flex flex-col text-secondText">
        ...
        <p className="m-1">+971 50 xxx xxxx</p>
        <p>mohamad@gmail.com</p>
      </div>
    </div>
  );
};
